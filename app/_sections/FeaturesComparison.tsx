  ...
  const features = [
    {
      ...
      Mentisy: { status: "premium", label: "4 Games" },
    ...
    {
      name: "Scratch & Reveal",
      Mentisy: { status: "premium", label: "Unique" },
      instagram: { status: "cross", label: "" },
    ...
    },
    {
      ...
      Mentisy: { status: "premium", label: "Reveal Rush" },
      instagram: { status: "cross", label: "" },
      snapchat: { status: "cross", label: "" },
      others: { status: "cross", label: "" }
    },
    {
      ...
      Mentisy: { status: "premium", label: "Rate My..." },
      instagram: { status: "cross", label: "" },
      snapchat: { status: "cross", label: "" },
      others: { status: "cross", label: "" }
    },
    ...
    <div className="px-4 sm:px-6 py-12 sm:py-16 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 dark:from-purple-900/20 dark:via-pink-900/20 dark:to-orange-900/20">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 px-2">Why Mentisy is the ultimate fun platform</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gradient-to-r from-[#FF75A0]/5 to-[#FFAA70]/5 dark:from-[#FF75A0]/10 dark:to-[#FFAA70]/10 rounded-lg p-4 border-2 border-dashed border-gradient-to-r from-[#FF75A0]/30 to-[#FFAA70]/30">
                    <div className="text-center">
                      <div className="font-semibold bg-gradient-to-r from-[#FF75A0] to-[#FFAA70] bg-clip-text text-transparent text-sm mb-2">Mentisy</div>
                      {renderStatusIcon(feature.Mentisy.status, feature.Mentisy.label)}
                    </div>
                  </div>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-[#FF75A0]/15 to-[#FFAA70]/15 dark:from-[#FF75A0]/25 dark:to-[#FFAA70]/25">
                  <tr>
                    ...
                    <th className="px-4 py-4 text-center font-semibold bg-gradient-to-r from-[#FF75A0] to-[#FFAA70] bg-clip-text text-transparent text-sm">Mentisy</th>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-[#FF75A0]/15 to-[#FFAA70]/15 dark:from-[#FF75A0]/25 dark:to-[#FFAA70]/25">
                  <tr>
                    ...
                    <th className="px-8 py-6 text-center font-bold bg-gradient-to-r from-[#FF75A0] to-[#FFAA70] bg-clip-text text-transparent text-lg">Mentisy</th>
