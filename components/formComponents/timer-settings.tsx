...
export function TimerSettings({ duration, onDurationChange, isTimerDisabled }: TimerSettingsProps) {
    return (
        <div>
            ...
            {isTimerDisabled && (
                <div className="mb-6 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-300 dark:border-amber-700">
                    <div className="flex items-center space-x-3 text-amber-800 dark:text-amber-200">
                        <span className="text-xl">⏱️</span>
                        <span className="font-medium text-sm">Video timer will match the video length automatically</span>
                    </div>
                </div>
            )}
            <RadioGroup 
            ...
            >
                <div className={`relative ${isTimerDisabled ? 'opacity-50' : ''}`}>
                    ...
                    <Label 
                        htmlFor="r1" 
                        className={`flex flex-col items-center justify-center p-4 sm:p-5 border-2 rounded-xl cursor-pointer transition-all hover:scale-105 ${
                            duration === '3' 
                    ...
                    >
                        ...
                        <span className="font-semibold text-base sm:text-lg">3 Sec</span>
                ...
                <div className={`relative ${isTimerDisabled ? 'opacity-50' : ''}`}>
                    ...
                    >
                        <span className="text-2xl sm:text-3xl mb-2">👀</span>
                        <span className="font-semibold text-base sm:text-lg">5 Sec</span>
                ...
                <div className={`relative ${isTimerDisabled ? 'opacity-50' : ''}`}>
                    ...
                    >
                        <span className="text-2xl sm:text-3xl mb-2">🧠</span>
                        <span className="font-semibold text-base sm:text-lg">10 Sec</span>
