...
export function UseCaseTips({ useCase, isVisible, onClose }: UseCaseTipsProps) {
    ...
    return (
        <div className="mb-6 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6 animate-in slide-in-from-top duration-300">
